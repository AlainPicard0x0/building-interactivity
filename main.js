...
function mainFunction() {
    ...
    document.getElementById("change-text-color").addEventListener("click", (event) => event.target.style.color = "black");
    ...
    document.getElementById("change-text-color").addEventListener("click", (event) => event.target.innerText = "Hello World");
    ...
    document.getElementById("subscribe-button").addEventListener("click", () => alert("Thank you for subscribing"));
    ...
    document.querySelectorAll(".card-btn").forEach(btn => btn.onclick = (event) => event.target.style.visibility = "hidden")
    ...
    document.querySelector(".input-field").addEventListener("keyup", (event) => (/h/.test(event.target.value)) ? alert(event.target.value) : null)
    ...
    newsletterHeader.addEventListener("mouseover", () => newsletterHeader.style.color = "red");
    newsletterHeader.addEventListener("mouseout", () => newsletterHeader.style.color = "white");
    ...
    addDiv.addEventListener("click", () => {
        ...
        newDiv.innerHTML = "<p>Some Text</p>";
